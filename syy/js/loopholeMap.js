	...
	_charts.prototype._outbreak = function(){
		...
		option = {
			backgroundColor:{
			    ...
			    y2: 1,
			    colorStops: [{
			        offset: 0, color: '#171B27' // 0% 处的颜色
			    }, {
			        offset: 1, color: '#0D0E22' // 100% 处的颜色
			    }],
		    ...
		    series: [
		        {
		            ...
		            axisLine: {            // 坐标轴线
		                ...
		                color: [[0.2,new echarts.graphic.LinearGradient(1, 0, 0, 1, [{
                            "offset": 0,
                            "color": '#09AFA6'
                        }, {
                            "offset": 1,
		            ...
		            itemStyle:{
		            	normal:{
		            		...
		            		color:{
							    ...
							    y2: 1,
							    colorStops: [{
							        offset: 0, color: '#AF0E22' // 0% 处的颜色
							    }, {
							        offset: 1, color: '#520D20' // 100% 处的颜色
							    }],
							    globalCoord: false // 缺省为 false
		                	}
		            	}
		            ...
		            itemStyle:{
		            	normal:{
		            		...
		            		color:{
							    ...
							    y2: 1,
							    colorStops: [{
							        offset: 0, color: '#0E63BB' // 0% 处的颜色
							    }, {
							        offset: 1, color: '#0C0E3D' // 100% 处的颜色
							    }],
							    globalCoord: false // 缺省为 false
		                	}
		            	}
		            ...
		            itemStyle:{
		            	normal:{
		            		...
		            		color:{
							    ...
							    y2: 1,
							    colorStops: [{
							        offset: 0, color: '#329B3B' // 0% 处的颜色
							    }, {
							        offset: 1, color: '#0D2921' // 100% 处的颜色
							    }],
							    globalCoord: false // 缺省为 false
		                	}
		            	}
	...
	_charts.prototype._mapRightPie = function(){
		var data = [
		                ...
		                {value:234, name:'pop3'},
		                {value:135, name:'ssh'},
		                {value:1548, name:'telnet'},
		                {value:1948, name:'dns'},
		                {value:2148, name:'dhcp'},
		                {value:2248, name:'ntp'},
		                {value:2348, name:'smtp'},
		                {value:2548, name:'http'}
		            ];
		function randomData() {
		    return Math.round(Math.random()*4000);
		}
	...
	var tableSlide = function(){
		...
		tbody.animate({'top':-trHeight},500,function(){
